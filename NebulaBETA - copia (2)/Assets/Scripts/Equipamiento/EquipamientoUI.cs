...
public class EquipamientoUI : MonoBehaviour {
	...
	void Update () {
        if (Input.GetButtonDown("Equipamiento")) //Si se presiona el botón para "Inventario" (Agregué un "Input" extra en los parámetros de Unity, que vincula "Inventario" con la letra i.
        {
